...
<div class="twitter">
 ...
 echo "<br />";
    ...
    <form name="modif" method="post">
        ...
        Nouveau résumé : <input type="text" name="resume"/><br/>
        <br/>
        Nombre de place disponible: <input type="text" name="nb_equipe"/><br/>
        <br/>
...
<input type="submit" name="valider" value="Modifier"/><br/>
        <br/>
    </form>
...
$sujet=$tab['suj'];
    ...
    $res=mysqli_query($connexion,"UPDATE `sujet` SET `resume` = '$resume', `places` = '$nb_equipe' WHERE `sujet`.`nom` = '$sujet';");
